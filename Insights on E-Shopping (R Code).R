...
setwd("C:/Users/unaan/OneDrive/Desktop/Documents/Ank1/UTD/Sem 2/BA with R")
...
index <- createDataPartition(df1$Revenue, p=0.75, list=FALSE) #createDataPartition not working
train <-df1[ index,]
test <- df1[-index,]
